 ...
 Swal.fire({
   ...
   draggable: true
    ...
    return (
      ...
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Add New Plant</h2>
      <form onSubmit={handleaddPlants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
        ...
        <div>
          ...
          <input name='plantName' type="text" placeholder="  plant name" className="input input-bordered w-full" />
        </div>
        ...
        <div>
          ...
          <input name='frequency' type="text" placeholder=" every 2 days" className="input input-bordered w-full" />
        </div>

        <div>
          <label className="block text-sm font-medium mb-1">Last Watered Date</label>
          <input name='lastLate' type="date" className="input input-bordered w-full" />
        </div>

        <div>
          <label className="block text-sm font-medium mb-1">Next Watering Date</label>
          <input name='nextDate' type="date" className="input input-bordered w-full" />
        </div>

        <div>
          <label className="block text-sm font-medium mb-1">Health Status</label>
          <input name='healthStatus' type="text" placeholder=" Healthy, Wilting" className="input input-bordered w-full" />
        </div>
